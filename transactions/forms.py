...
class TransactionForm(forms.ModelForm):
    ...
    ifsc_code = forms.CharField(max_length=20, label="IFSC Code")
    captcha = forms.IntegerField(help_text="Security Question: What is 5 + 3?")
    ...
    def clean_captcha(self):
        ...
        if captcha_response != 8:
            raise forms.ValidationError("Invalid security answer. Please try again.")
